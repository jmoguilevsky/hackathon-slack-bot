...
var StepTypes_enum_1 = require("../common/enums/StepTypes.enum");
var flowExample = {
...
function getStepHTMLStructure(stepList) {
    ...
    if (step.type === StepTypes_enum_1["default"].CONDITIONAL) {
        var branches = step.conditionsBranches.map(function (branch) { return getStepHTMLStructure(branch.steps); }).join('');
...
var salesforceImg = fs.readFileSync(dirname + "/icons/salesforce.png");
// @ts-ignore
var salesforceBase64 = new Buffer.from(salesforceImg).toString('base64');
var salesforceUrI = 'data:image/jpeg;base64,' + salesforceBase64;
nodeHtmlToImage({
    output: './image.png',
